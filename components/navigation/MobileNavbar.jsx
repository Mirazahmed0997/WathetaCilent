...
// Product and industry data (same as Navbar)
const products = [
    {
            ...
            <Sheet>
                ...
                <SheetContent side="left" className="w-[85%] sm:w-[400px]">
                    ...
                    <nav className="mt-6 flex flex-col space-y-4 px-4 overflow-y-auto">
                        ...
                        <Link href="/pricing" className="text-base font-medium hover:text-green-600">
                            Pricing
                        </Link>

                        <Link href="/features" className="text-base font-medium hover:text-green-600">
                            Features
                        </Link>

                        <Link href="/blog" className="text-base font-medium hover:text-green-600">
                            Blog
                        </Link>

                        <Link href="/contact" className="text-base font-medium hover:text-green-600">
                            Contact
                        </Link>

                        <div className="flex flex-col gap-2 pt-4 border-t mt-4">
                            <Link href="https://dash.watheta.com/login">
