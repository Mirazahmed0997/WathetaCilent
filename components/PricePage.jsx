...
const PricePage = () => {
  ...
  return (
    ...
    //             </p>
    //             <p className="featuresDiscription flex items-center border-b featuresTextPadding border-gray-500 text-red-500">
    //               <span className="me-2">
    ...
    //   {/* pricing for phone */}
    //   <PhonePriceSection isToggle={isToggle} />
    //   <section className="">
    ...
    //       </div>
    //       {/* card  */}
    //       <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-5 lg:gap-8 xl:gap-8 pt-10">
    //         <div className="cardBgColor py-2 lg:py-5 xl:py-5 md:py-5 px-3 lg:px-6 xl:px-6 md:px-4 border rounded-lg">
    //           {/* icon */}
    ...
    //             />
    //           </div>
    //           <div className="py-2 lg:py-4 xl:py-4">
