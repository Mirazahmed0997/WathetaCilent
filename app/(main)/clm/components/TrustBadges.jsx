      ...
      <div className="hidden sm:grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-6 justify-center">
        {services.map((service, index) => {
          ...
          return (
            <div
              key={index}
              className={cn("bg-gray-50 shadow-xl/20 shadow-indigo-500/50 hover:shadow-xl/30  hover:bg-purple-200 transition-all p-2 rounded-xl flex flex-col items-center ",
                  index % 2 === 1 ? 'mt-4' : 'mt-0',
                )}
            >
